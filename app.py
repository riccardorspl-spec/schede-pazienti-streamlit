...
def carica_database():
    ...
    try:
        ...
        if not worksheet:
            st.warning("⚠️ Impossibile connettersi a Google Sheets")
            return {}
...
# --------------------------------------------------
    ...
    # Se ha scelto un template, carica gli esercizi
    esercizi_template = TEMPLATES[template_scelto]
    
    if esercizi_template:
        st.success(f"✅ Template '{template_scelto}' caricato! Puoi modificare serie/ripetizioni sotto.")
